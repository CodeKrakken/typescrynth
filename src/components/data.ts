...
export const keys: keysType = {
  ...
  's': {htmlTitle: 'C#',        function: 17.32,      type: 'note',     isHeld: false, row: 2, column: -3, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'd': {htmlTitle: 'D#',        function: 19.45,      type: 'note',     isHeld: false, row: 2, column: -2, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'g': {htmlTitle: 'F#',        function: 23.12,      type: 'note',     isHeld: false, row: 2, column:  0, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'h': {htmlTitle: 'G#',        function: 25.96,      type: 'note',     isHeld: false, row: 2, column:  1, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'j': {htmlTitle: 'A#',        function: 29.14,      type: 'note',     isHeld: false, row: 2, column:  2, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 

  'z': {htmlTitle: 'C',         function: 16.35,      type: 'note',     isHeld: false, row: 3, column: -3, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'x': {htmlTitle: 'D',         function: 18.35,      type: 'note',     isHeld: false, row: 3, column: -2, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'c': {htmlTitle: 'E',         function: 20.60,      type: 'note',     isHeld: false, row: 3, column: -1, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'v': {htmlTitle: 'F',         function: 21.83,      type: 'note',     isHeld: false, row: 3, column:  0, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}}, 
  'b': {htmlTitle: 'G',         function: 24.50,      type: 'note',     isHeld: false, row: 3, column:  1, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}},
  'n': {htmlTitle: 'A',         function: 27.50,      type: 'note',     isHeld: false, row: 3, column:  2, colour: '', nodes: {'sine': [], 'triangle': [], 'sawtooth': [], 'square': []}},
